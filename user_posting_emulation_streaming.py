...
def run_infinite_post_data_loop():
    while True:
        ...
        with engine.connect() as connection:
            ...
            invoke_url = "https://s3r2ivz473.execute-api.us-east-1.amazonaws.com/streams/streaming-0a1e5630c127-pin/record"
            ...
            #invoke_url = "https://s3r2ivz473.execute-api.us-east-1.amazonaws.com/streams/streaming-0a1e5630c127-geo/record"
            #payload = json.dumps({
             #   "stream-name": "YourStreamName",
              #  "records": {
                    #Data should be send as pairs of column_name:value, with different columns separated by commas       
            ...
            #invoke_url = "https://s3r2ivz473.execute-api.us-east-1.amazonaws.com/streams/streaming-0a1e5630c127-user/record"
            #payload = json.dumps({
             #   "stream-name": "YourStreamName",
              #  "records":{
                    #Data should be send as pairs of column_name:value, with different columns separated by commas       
